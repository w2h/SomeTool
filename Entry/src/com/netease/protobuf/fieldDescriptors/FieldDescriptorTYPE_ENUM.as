package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class FieldDescriptorTYPE_ENUM extends FieldDescriptor
   {
       
      public var enumType:Class;
      
      public function FieldDescriptorTYPE_ENUM(param1:String, param2:String, param3:uint, param4:Class)
      {
         super();
