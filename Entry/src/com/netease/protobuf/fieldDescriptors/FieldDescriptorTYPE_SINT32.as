package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class FieldDescriptorTYPE_SINT32 extends FieldDescriptor
   {
       
      public function FieldDescriptorTYPE_SINT32(param1:String, param2:String, param3:uint)
      {
         super();
