package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class FieldDescriptorTYPE_STRING extends FieldDescriptor
   {
       
      public function FieldDescriptorTYPE_STRING(param1:String, param2:String, param3:uint)
      {
         super();
