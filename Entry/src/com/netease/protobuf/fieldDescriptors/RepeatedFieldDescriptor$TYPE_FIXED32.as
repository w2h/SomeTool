package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptor$TYPE_FIXED32 extends RepeatedFieldDescriptor
   {
       
      public function RepeatedFieldDescriptor$TYPE_FIXED32(param1:String, param2:String, param3:uint)
      {
         super();
      ...
      {
         return ReadUtils.read$TYPE_FIXED32(param1);
      }
      
      override public function writeSingleField(param1:WritingBuffer, param2:*) : void
      {
         WriteUtils.write$TYPE_FIXED32(param1,param2);
      }
