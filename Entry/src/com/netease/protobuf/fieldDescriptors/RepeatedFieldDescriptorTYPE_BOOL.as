package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptorTYPE_BOOL extends RepeatedFieldDescriptor
   {
       
      public function RepeatedFieldDescriptorTYPE_BOOL(param1:String, param2:String, param3:uint)
      {
         super();
