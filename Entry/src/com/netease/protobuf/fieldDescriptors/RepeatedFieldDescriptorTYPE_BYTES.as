package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptorTYPE_BYTES extends RepeatedFieldDescriptor
   {
       
      public function RepeatedFieldDescriptorTYPE_BYTES(param1:String, param2:String, param3:uint)
      {
         super();
