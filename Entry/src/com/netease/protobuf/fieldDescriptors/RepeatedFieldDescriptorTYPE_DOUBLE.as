package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptorTYPE_DOUBLE extends RepeatedFieldDescriptor
   {
       
      public function RepeatedFieldDescriptorTYPE_DOUBLE(param1:String, param2:String, param3:uint)
      {
         super();
