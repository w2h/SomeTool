package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptorTYPE_ENUM extends RepeatedFieldDescriptor
   {
       
      public var enumType:Class;
      
      public function RepeatedFieldDescriptorTYPE_ENUM(param1:String, param2:String, param3:uint, param4:Class)
      {
         super();
