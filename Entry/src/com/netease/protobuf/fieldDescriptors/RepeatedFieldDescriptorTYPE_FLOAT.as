package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptorTYPE_FLOAT extends RepeatedFieldDescriptor
   {
       
      public function RepeatedFieldDescriptorTYPE_FLOAT(param1:String, param2:String, param3:uint)
      {
         super();
