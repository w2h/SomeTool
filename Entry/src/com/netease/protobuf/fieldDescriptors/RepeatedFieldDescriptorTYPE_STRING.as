package com.netease.protobuf.fieldDescriptors
{
   ...
   public final class RepeatedFieldDescriptorTYPE_STRING extends RepeatedFieldDescriptor
   {
       
      public function RepeatedFieldDescriptorTYPE_STRING(param1:String, param2:String, param3:uint)
      {
         super();
