package rumorPlot.extPlot.script
{
   ...
   import rumorPlot.command.RumorEnterSceneCommand;
   
   public class EnterSceneScript extends Script
   {
       
      public function EnterSceneScript()
      {
         super();
      }
      ...
      override public function activate() : void
      {
         ...
         new RumorEnterSceneCommand(_loc1_).call();
         super.activate();
      }
