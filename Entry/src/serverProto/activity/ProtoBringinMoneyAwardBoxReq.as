package serverProto.activity
{
   ...
   public final class ProtoBringinMoneyAwardBoxReq extends Message
   {
      
      public static const BOX_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activity.ProtoBringinMoneyAwardBoxReq.box_id","boxId",1 << 3 | WireType.VARINT);
       
      private var box_id$field:int;
      
      private var hasField$0:uint = 0;
      
      public function ProtoBringinMoneyAwardBoxReq()
      {
         super();
      }
