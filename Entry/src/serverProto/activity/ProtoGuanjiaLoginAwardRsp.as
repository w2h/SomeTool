package serverProto.activity
{
   ...
   public final class ProtoGuanjiaLoginAwardRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoGuanjiaLoginAwardRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const AWARD_STATUS:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoGuanjiaLoginAwardRsp.award_status","awardStatus",2 << 3 | WireType.VARINT);
      
      public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoGuanjiaLoginAwardRsp.box_id","boxId",3 << 3 | WireType.VARINT);
      ...
      public function ProtoGuanjiaLoginAwardRsp()
      {
         super();
      }
