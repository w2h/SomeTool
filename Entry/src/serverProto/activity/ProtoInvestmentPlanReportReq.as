package serverProto.activity
{
   ...
   public final class ProtoInvestmentPlanReportReq extends Message
   {
      
      public static const TYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoInvestmentPlanReportReq.type","type",1 << 3 | WireType.VARINT);
      
      public static const DATA1:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoInvestmentPlanReportReq.data1","data1",3 << 3 | WireType.VARINT);
      
      public static const DATA2:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoInvestmentPlanReportReq.data2","data2",4 << 3 | WireType.VARINT);
      
      public static const DATA3:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoInvestmentPlanReportReq.data3","data3",5 << 3 | WireType.VARINT);
      ...
      public function ProtoInvestmentPlanReportReq()
      {
         super();
      }
