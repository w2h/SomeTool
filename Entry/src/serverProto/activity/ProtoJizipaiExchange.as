package serverProto.activity
{
   ...
   public final class ProtoJizipaiExchange extends Message
   {
      
      public static const SCORE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoJizipaiExchange.score","score",1 << 3 | WireType.VARINT);
      
      public static const AWARD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoJizipaiExchange.award","award",2 << 3 | WireType.LENGTH_DELIMITED,ProtoItemInfo);
      
      public static const LIMIT_EXCHANGE_NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoJizipaiExchange.limit_exchange_num","limitExchangeNum",3 << 3 | WireType.VARINT);
      
      public static const EXCHANGED_NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoJizipaiExchange.exchanged_num","exchangedNum",4 << 3 | WireType.VARINT);
      ...
      public function ProtoJizipaiExchange()
      {
         super();
      }
