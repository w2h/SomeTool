package serverProto.activity
{
   ...
   public final class ProtoLanternQueryRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoLanternQueryRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const SCORE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoLanternQueryRsp.score","score",2 << 3 | WireType.VARINT);
      
      public static const BEGIN_TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoLanternQueryRsp.begin_time","beginTime",3 << 3 | WireType.VARINT);
      
      public static const END_TIME:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoLanternQueryRsp.end_time","endTime",4 << 3 | WireType.VARINT);
      
      public static const AWARD_STATE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoLanternQueryRsp.award_state","awardState",5 << 3 | WireType.VARINT);
      
      public static const AWARD:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoLanternQueryRsp.award","award",6 << 3 | WireType.LENGTH_DELIMITED,ProtoItemInfo);
      ...
      public function ProtoLanternQueryRsp()
      {
         this.award = [];
         super();
      }
