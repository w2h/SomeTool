package serverProto.activity
{
   ...
   public final class ProtoNewOpenServiceQueryReq extends Message
   {
      
      public static const TAB_IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoNewOpenServiceQueryReq.tab_idx","tabIdx",1 << 3 | WireType.VARINT);
       
      private var tab_idx$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoNewOpenServiceQueryReq()
      {
         super();
      }
