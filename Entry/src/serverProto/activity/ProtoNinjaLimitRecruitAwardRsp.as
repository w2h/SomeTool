package serverProto.activity
{
   ...
   public final class ProtoNinjaLimitRecruitAwardRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoNinjaLimitRecruitAwardRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoNinjaLimitRecruitAwardRsp.box_id","boxId",2 << 3 | WireType.VARINT);
      
      public static const AWARD_STATUS:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activity.ProtoNinjaLimitRecruitAwardRsp.award_status","awardStatus",3 << 3 | WireType.VARINT);
      ...
      public function ProtoNinjaLimitRecruitAwardRsp()
      {
         super();
      }
