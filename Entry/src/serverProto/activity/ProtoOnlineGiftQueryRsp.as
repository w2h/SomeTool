package serverProto.activity
{
   ...
   public final class ProtoOnlineGiftQueryRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoOnlineGiftQueryRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const LEFT_AWARD_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activity.ProtoOnlineGiftQueryRsp.left_award_time","leftAwardTime",2 << 3 | WireType.VARINT);
      
      public static const AWARD_LIST:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoOnlineGiftQueryRsp.award_list","awardList",3 << 3 | WireType.LENGTH_DELIMITED,ProtoAwardList);
      ...
      public function ProtoOnlineGiftQueryRsp()
      {
         super();
      }
