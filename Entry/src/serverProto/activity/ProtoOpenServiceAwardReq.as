package serverProto.activity
{
   ...
   public final class ProtoOpenServiceAwardReq extends Message
   {
      
      public static const TAB_IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoOpenServiceAwardReq.tab_idx","tabIdx",1 << 3 | WireType.VARINT);
      
      public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoOpenServiceAwardReq.box_id","boxId",2 << 3 | WireType.VARINT);
      ...
      public function ProtoOpenServiceAwardReq()
      {
         super();
      }
