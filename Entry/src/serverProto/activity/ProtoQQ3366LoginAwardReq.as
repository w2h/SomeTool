package serverProto.activity
{
   ...
   public final class ProtoQQ3366LoginAwardReq extends Message
   {
      
      public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoQQ3366LoginAwardReq.box_id","boxId",1 << 3 | WireType.VARINT);
       
      private var box_id$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoQQ3366LoginAwardReq()
      {
         super();
      }
