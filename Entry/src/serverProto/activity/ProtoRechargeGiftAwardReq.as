package serverProto.activity
{
   ...
   public final class ProtoRechargeGiftAwardReq extends Message
   {
      
      public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeGiftAwardReq.box_id","boxId",1 << 3 | WireType.VARINT);
      
      public static const AWARD_IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoRechargeGiftAwardReq.award_idx","awardIdx",2 << 3 | WireType.VARINT);
      ...
      public function ProtoRechargeGiftAwardReq()
      {
         super();
      }
