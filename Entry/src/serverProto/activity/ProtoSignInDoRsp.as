package serverProto.activity
{
   ...
   public final class ProtoSignInDoRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoSignInDoRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const SIGN_IN_DATA:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoSignInDoRsp.sign_in_data","signInData",2 << 3 | WireType.LENGTH_DELIMITED,ProtoSignInData);
       
      private var ret$field:ProtoRetInfo;
      
      private var sign_in_data$field:serverProto.activity.ProtoSignInData;
      
      public function ProtoSignInDoRsp()
      {
         super();
      }
