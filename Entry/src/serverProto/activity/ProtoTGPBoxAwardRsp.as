package serverProto.activity
{
   ...
   public final class ProtoTGPBoxAwardRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.activity.ProtoTGPBoxAwardRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const BOX_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoTGPBoxAwardRsp.box_id","boxId",2 << 3 | WireType.VARINT);
      
      public static const AWARD_STATUS:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoTGPBoxAwardRsp.award_status","awardStatus",3 << 3 | WireType.VARINT);
      ...
      public function ProtoTGPBoxAwardRsp()
      {
         super();
      }
