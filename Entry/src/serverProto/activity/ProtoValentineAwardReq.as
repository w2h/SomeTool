package serverProto.activity
{
   ...
   public final class ProtoValentineAwardReq extends Message
   {
      
      public static const TASK_IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoValentineAwardReq.task_idx","taskIdx",1 << 3 | WireType.VARINT);
       
      private var task_idx$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoValentineAwardReq()
      {
         super();
      }
