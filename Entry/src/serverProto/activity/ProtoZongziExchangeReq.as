package serverProto.activity
{
   ...
   public final class ProtoZongziExchangeReq extends Message
   {
      
      public static const IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.activity.ProtoZongziExchangeReq.idx","idx",1 << 3 | WireType.VARINT);
       
      private var idx$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoZongziExchangeReq()
      {
         super();
      }
