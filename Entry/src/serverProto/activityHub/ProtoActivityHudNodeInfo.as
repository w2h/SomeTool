package serverProto.activityHub
{
   ...
   public final class ProtoActivityHudNodeInfo extends Message
   {
      
      public static const ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHudNodeInfo.id","id",1 << 3 | WireType.VARINT);
      
      public static const TIME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.activityHub.ProtoActivityHudNodeInfo.time","time",2 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const DAY:RepeatedFieldDescriptor$TYPE_INT32 = new RepeatedFieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHudNodeInfo.day","day",3 << 3 | WireType.VARINT);
      
      public static const SPECIAL_DAY:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.activityHub.ProtoActivityHudNodeInfo.special_day","specialDay",4 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const ALL_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHudNodeInfo.all_time","allTime",5 << 3 | WireType.VARINT);
      
      public static const REMAINDER_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.activityHub.ProtoActivityHudNodeInfo.remainder_time","remainderTime",6 << 3 | WireType.VARINT);
      
      public static const STATUS:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.activityHub.ProtoActivityHudNodeInfo.status","status",7 << 3 | WireType.VARINT,ProtoActivityStatus);
      
      public static const MEET_SPECIAL_CONDITION:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.activityHub.ProtoActivityHudNodeInfo.meet_special_condition","meetSpecialCondition",8 << 3 | WireType.VARINT);
      ...
      public function ProtoActivityHudNodeInfo()
      {
         this.day = [];
         super();
      }
