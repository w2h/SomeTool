package serverProto.baseInfo
{
   ...
   public final class ProtoNinjaLegendConf extends Message
   {
      ...
      public static const NINJA_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.baseInfo.ProtoNinjaLegendConf.ninja_id","ninjaId",1 << 3 | WireType.VARINT);
      
      public static const NEED_STAR:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.baseInfo.ProtoNinjaLegendConf.need_star","needStar",2 << 3 | WireType.VARINT);
      
      public static const NEED_LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.baseInfo.ProtoNinjaLegendConf.need_level","needLevel",3 << 3 | WireType.VARINT);
      
      public static const NEED_FAVOUR:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.baseInfo.ProtoNinjaLegendConf.need_favour","needFavour",4 << 3 | WireType.VARINT);
      
      public static const NEED_FINISH_NINJA_ARY:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("serverProto.baseInfo.ProtoNinjaLegendConf.need_finish_ninja_ary","needFinishNinjaAry",5 << 3 | WireType.VARINT);
      
      public static const NEED_SEQUENCE_NINJA_ARY:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("serverProto.baseInfo.ProtoNinjaLegendConf.need_sequence_ninja_ary","needSequenceNinjaAry",6 << 3 | WireType.VARINT);
      
      public static const CLIENT_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.baseInfo.ProtoNinjaLegendConf.client_id","clientId",7 << 3 | WireType.VARINT);
      
      public static const SORT_ID:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.baseInfo.ProtoNinjaLegendConf.sort_id","sortId",8 << 3 | WireType.VARINT);
      ...
      public function clearSortId() : void
      {
         this.hasField$0 = this.hasField$0 & 4.294967263E9;
         this.sort_id$field = new int();
      }
      
      public function get hasSortId() : Boolean
      {
      ...
      public function set sortId(param1:int) : void
      {
         ...
         this.sort_id$field = param1;
      }
      
      public function get sortId() : int
      {
         return this.sort_id$field;
      }
      ...
      override used_by_generated_code function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasSortId)
         {
            ...
            WriteUtils.write$TYPE_SINT32(param1,this.sort_id$field);
         }
         for(_loc4_ in this)
         {
