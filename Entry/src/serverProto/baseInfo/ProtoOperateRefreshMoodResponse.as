package serverProto.baseInfo
{
   ...
   public final class ProtoOperateRefreshMoodResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoOperateRefreshMoodResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const NINJA_MOOD_DETAIL_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoOperateRefreshMoodResponse.ninja_mood_detail_info","ninjaMoodDetailInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoNinjaMoodDetailInfo);
       
      public var ret:ProtoRetInfo;
      
      private var ninja_mood_detail_info$field:serverProto.baseInfo.ProtoNinjaMoodDetailInfo;
      
      public function ProtoOperateRefreshMoodResponse()
      {
         super();
      }
