package serverProto.baseInfo
{
   ...
   public final class ProtoUseRoleMoodResponse extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoUseRoleMoodResponse.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const MOOD_LIST:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.baseInfo.ProtoUseRoleMoodResponse.mood_list","moodList",2 << 3 | WireType.LENGTH_DELIMITED,ProtoRoleMoodList);
       
      public var retInfo:ProtoRetInfo;
      
      private var mood_list$field:serverProto.baseInfo.ProtoRoleMoodList;
      
      public function ProtoUseRoleMoodResponse()
      {
         super();
      }
