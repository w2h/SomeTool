package serverProto.basePvp
{
   ...
   public final class ProtoUpdateBaseNotify extends Message
   {
      
      public static const BASE_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.basePvp.ProtoUpdateBaseNotify.base_info","baseInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoBaseInfo);
       
      private var base_info$field:serverProto.basePvp.ProtoBaseInfo;
      
      public function ProtoUpdateBaseNotify()
      {
         super();
      }
