package serverProto.bath
{
   ...
   public final class ProtoBathSelfResp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.bath.ProtoBathSelfResp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const REST_SEC:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bath.ProtoBathSelfResp.rest_sec","restSec",2 << 3 | WireType.VARINT);
      
      public static const STRENGTH:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bath.ProtoBathSelfResp.strength","strength",3 << 3 | WireType.VARINT);
      
      public static const REST_HELP_BATH_TIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bath.ProtoBathSelfResp.rest_help_bath_times","restHelpBathTimes",4 << 3 | WireType.VARINT);
      
      public static const REST_BUY_BATH_TIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.bath.ProtoBathSelfResp.rest_buy_bath_times","restBuyBathTimes",5 << 3 | WireType.VARINT);
      ...
      public function ProtoBathSelfResp()
      {
         super();
      }
