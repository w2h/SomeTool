package serverProto.battleRoyale
{
   ...
   public final class ProtoInnerGetBattleRoyaleSchemaReq extends Message
   {
      
      public static const AUTO_POLL:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.battleRoyale.ProtoInnerGetBattleRoyaleSchemaReq.auto_poll","autoPoll",1 << 3 | WireType.VARINT);
       
      private var auto_poll$field:Boolean;
      
      private var hasField$0:uint = 0;
      
      public function ProtoInnerGetBattleRoyaleSchemaReq()
      {
         super();
      }
