package serverProto.blackMarket
{
   ...
   public final class ProtoBlackMarketOpenResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.blackMarket.ProtoBlackMarketOpenResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const BLACK_MARKET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.blackMarket.ProtoBlackMarketOpenResponse.black_market_info","blackMarketInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoBlackMarketInfo);
       
      public var ret:ProtoRetInfo;
      
      private var black_market_info$field:serverProto.blackMarket.ProtoBlackMarketInfo;
      
      public function ProtoBlackMarketOpenResponse()
      {
         super();
      }
