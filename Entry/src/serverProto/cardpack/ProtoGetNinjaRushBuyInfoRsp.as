package serverProto.cardpack
{
   ...
   public final class ProtoGetNinjaRushBuyInfoRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.cardpack.ProtoGetNinjaRushBuyInfoRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const NINJA_RUSH_BUY_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.cardpack.ProtoGetNinjaRushBuyInfoRsp.ninja_rush_buy_info","ninjaRushBuyInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoNinjaRushBuyInfo);
       
      public var ret:ProtoRetInfo;
      
      private var ninja_rush_buy_info$field:serverProto.cardpack.ProtoNinjaRushBuyInfo;
      
      public function ProtoGetNinjaRushBuyInfoRsp()
      {
         super();
      }
