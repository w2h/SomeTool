package serverProto.challengeTower
{
   ...
   public final class ProtoChallengeTowerToolReq extends Message
   {
      
      public static const TYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.challengeTower.ProtoChallengeTowerToolReq.type","type",1 << 3 | WireType.VARINT);
      
      public static const DATA1:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.challengeTower.ProtoChallengeTowerToolReq.data1","data1",2 << 3 | WireType.VARINT);
      
      public static const DATA2:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.challengeTower.ProtoChallengeTowerToolReq.data2","data2",3 << 3 | WireType.VARINT);
      
      public static const DATA3:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.challengeTower.ProtoChallengeTowerToolReq.data3","data3",4 << 3 | WireType.VARINT);
      ...
      public function ProtoChallengeTowerToolReq()
      {
         super();
      }
