package serverProto.dungeon
{
   ...
   public final class ProtoDungeonDeathInfo extends Message
   {
      
      public static const IS_DEATH:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.dungeon.ProtoDungeonDeathInfo.is_death","isDeath",1 << 3 | WireType.VARINT);
      
      public static const SCENE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoDungeonDeathInfo.scene_id","sceneId",2 << 3 | WireType.VARINT);
      
      public static const LOCATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.dungeon.ProtoDungeonDeathInfo.location","location",3 << 3 | WireType.LENGTH_DELIMITED,ProtoPoint);
      ...
      public function ProtoDungeonDeathInfo()
      {
         super();
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         WriteUtils.write$TYPE_BOOL(param1,this.isDeath);
         if(this.hasSceneId)
         {
