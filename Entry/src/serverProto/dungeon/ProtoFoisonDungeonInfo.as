package serverProto.dungeon
{
   ...
   public final class ProtoFoisonDungeonInfo extends Message
   {
      
      public static const DUNGEON_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoFoisonDungeonInfo.dungeon_id","dungeonId",1 << 3 | WireType.VARINT);
      
      public static const IS_OPEN:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.dungeon.ProtoFoisonDungeonInfo.is_open","isOpen",2 << 3 | WireType.VARINT);
      
      public static const OPEN_DAY:RepeatedFieldDescriptor$TYPE_INT32 = new RepeatedFieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoFoisonDungeonInfo.open_day","openDay",3 << 3 | WireType.VARINT);
      
      public static const NEED_POWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoFoisonDungeonInfo.need_power","needPower",4 << 3 | WireType.VARINT);
      
      public static const PASS_TIMES:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoFoisonDungeonInfo.pass_times","passTimes",5 << 3 | WireType.VARINT);
      
      public static const PASS_ULIMIT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.dungeon.ProtoFoisonDungeonInfo.pass_ulimit","passUlimit",6 << 3 | WireType.VARINT);
      
      public static const COOL_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoFoisonDungeonInfo.cool_time","coolTime",7 << 3 | WireType.VARINT);
      
      public static const EASY_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoFoisonDungeonInfo.easy_open_level","easyOpenLevel",8 << 3 | WireType.VARINT);
      
      public static const NORMAL_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoFoisonDungeonInfo.normal_open_level","normalOpenLevel",9 << 3 | WireType.VARINT);
      
      public static const HARD_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoFoisonDungeonInfo.hard_open_level","hardOpenLevel",10 << 3 | WireType.VARINT);
      
      public static const VERY_HARD_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoFoisonDungeonInfo.very_hard_open_level","veryHardOpenLevel",11 << 3 | WireType.VARINT);
      
      public static const ULTIMATE_OPEN_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoFoisonDungeonInfo.ultimate_open_level","ultimateOpenLevel",12 << 3 | WireType.VARINT);
      ...
      private var very_hard_open_level$field:int;
      
      private var ultimate_open_level$field:int;
      
      public function ProtoFoisonDungeonInfo()
      {
         this.openDay = [];
         super();
      }
      ...
      public function clearVeryHardOpenLevel() : void
      {
         this.hasField$0 = this.hasField$0 & 4.294967039E9;
         this.very_hard_open_level$field = new int();
      }
      
      public function get hasVeryHardOpenLevel() : Boolean
      {
         return (this.hasField$0 & 256) != 0;
      }
      
      public function set veryHardOpenLevel(param1:int) : void
      {
         this.hasField$0 = this.hasField$0 | 256;
         this.very_hard_open_level$field = param1;
      }
      
      public function get veryHardOpenLevel() : int
      {
         return this.very_hard_open_level$field;
      }
      
      public function clearUltimateOpenLevel() : void
      {
         this.hasField$0 = this.hasField$0 & 4.294966783E9;
         this.ultimate_open_level$field = new int();
      }
      
      public function get hasUltimateOpenLevel() : Boolean
      {
         return (this.hasField$0 & 512) != 0;
      }
      
      public function set ultimateOpenLevel(param1:int) : void
      {
         this.hasField$0 = this.hasField$0 | 512;
         this.ultimate_open_level$field = param1;
      }
      
      public function get ultimateOpenLevel() : int
      {
         return this.ultimate_open_level$field;
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasVeryHardOpenLevel)
         {
            WriteUtils.writeTag(param1,WireType.VARINT,11);
            WriteUtils.write$TYPE_INT32(param1,this.very_hard_open_level$field);
         }
         if(this.hasUltimateOpenLevel)
         {
            WriteUtils.writeTag(param1,WireType.VARINT,12);
            WriteUtils.write$TYPE_INT32(param1,this.ultimate_open_level$field);
         }
         for(_loc3_ in this)
         {
