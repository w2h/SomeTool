package serverProto.dungeon
{
   ...
   public final class ProtoGetDungeonReliveCostResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const RELIVE_ITEM_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.relive_item_num","reliveItemNum",2 << 3 | WireType.VARINT);
      
      public static const MONEY_COUPON_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.money_coupon_num","moneyCouponNum",3 << 3 | WireType.VARINT);
      
      public static const MONEY_GOLD_INGOT_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.money_gold_ingot_num","moneyGoldIngotNum",4 << 3 | WireType.VARINT);
      
      public static const NEED_RELIVE_ITEM_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.need_relive_item_num","needReliveItemNum",5 << 3 | WireType.VARINT);
      
      public static const NEED_MONEY_COUPON_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.need_money_coupon_num","needMoneyCouponNum",6 << 3 | WireType.VARINT);
      
      public static const NEED_MONEY_GOLD_INGOT_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.dungeon.ProtoGetDungeonReliveCostResponse.need_money_gold_ingot_num","needMoneyGoldIngotNum",7 << 3 | WireType.VARINT);
      ...
      public function ProtoGetDungeonReliveCostResponse()
      {
         super();
      }
