package serverProto.equipment
{
   ...
   public final class ProtoEquipmentInfoRequest extends Message
   {
      
      public static const KEY:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoEquipmentInfoRequest.key","key",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var key$field:ProtoPlayerKey;
      
      public function ProtoEquipmentInfoRequest()
      {
         super();
      }
