package serverProto.equipment
{
   ...
   public final class ProtoGetEquipForgeQualityReq extends Message
   {
      
      public static const EQUIP_SEQUENCE:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("serverProto.equipment.ProtoGetEquipForgeQualityReq.equip_sequence","equipSequence",1 << 3 | WireType.VARINT);
       
      private var equip_sequence$field:UInt64;
      
      public function ProtoGetEquipForgeQualityReq()
      {
         super();
      }
