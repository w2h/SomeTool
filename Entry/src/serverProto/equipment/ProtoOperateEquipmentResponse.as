package serverProto.equipment
{
   ...
   public final class ProtoOperateEquipmentResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoOperateEquipmentResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const NINJA_EQUIP:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoOperateEquipmentResponse.ninja_equip","ninjaEquip",2 << 3 | WireType.LENGTH_DELIMITED,ProtoFormationEquipmentInfo);
       
      public var ret:ProtoRetInfo;
      
      private var ninja_equip$field:serverProto.equipment.ProtoFormationEquipmentInfo;
      
      public function ProtoOperateEquipmentResponse()
      {
         super();
      }
