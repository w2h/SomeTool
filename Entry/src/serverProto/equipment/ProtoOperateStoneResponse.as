package serverProto.equipment
{
   ...
   public final class ProtoOperateStoneResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoOperateStoneResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const EQUIP_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoOperateStoneResponse.equip_info","equipInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoEquipInfo);
      
      public static const PROPERTY_CHANGE:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.equipment.ProtoOperateStoneResponse.property_change","propertyChange",3 << 3 | WireType.LENGTH_DELIMITED,ProtoNarutoProperty);
      
      public static const CMD_ID:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.equipment.ProtoOperateStoneResponse.cmd_id","cmdId",4 << 3 | WireType.VARINT,EquipStoneCommands);
      ...
      public function ProtoOperateStoneResponse()
      {
         super();
      }
