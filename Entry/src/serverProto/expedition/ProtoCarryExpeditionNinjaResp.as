package serverProto.expedition
{
   ...
   public final class ProtoCarryExpeditionNinjaResp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.expedition.ProtoCarryExpeditionNinjaResp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const NINJA_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.expedition.ProtoCarryExpeditionNinjaResp.ninja_info","ninjaInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoExpeditionNinjaListInfo);
       
      public var ret:ProtoRetInfo;
      
      private var ninja_info$field:serverProto.expedition.ProtoExpeditionNinjaListInfo;
      
      public function ProtoCarryExpeditionNinjaResp()
      {
         super();
      }
