package serverProto.family
{
   ...
   public final class ProtoDispatchNinjaFriendReq extends Message
   {
      
      public static const FRIEND_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.family.ProtoDispatchNinjaFriendReq.friend_id","friendId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const FRIEND_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.family.ProtoDispatchNinjaFriendReq.friend_name","friendName",2 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const IDX:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.family.ProtoDispatchNinjaFriendReq.idx","idx",3 << 3 | WireType.VARINT);
      ...
      public function ProtoDispatchNinjaFriendReq()
      {
         super();
      }
