package serverProto.family
{
   ...
   public final class ProtoFriendWishTreeInfo extends Message
   {
      
      public static const TREE_LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.tree_level","treeLevel",1 << 3 | WireType.VARINT);
      
      public static const TREE_EXP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.tree_exp","treeExp",2 << 3 | WireType.VARINT);
      
      public static const GROWTH_VALUE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.growth_value","growthValue",3 << 3 | WireType.VARINT);
      
      public static const GROWTH_VALUE_MAX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.growth_value_max","growthValueMax",4 << 3 | WireType.VARINT);
      
      public static const CAN_HELP_WATER:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.can_help_water","canHelpWater",5 << 3 | WireType.VARINT);
      
      public static const MAX_TREE_EXP:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.max_tree_exp","maxTreeExp",6 << 3 | WireType.VARINT);
      
      public static const LEFT_HELP_NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.family.ProtoFriendWishTreeInfo.left_help_num","leftHelpNum",7 << 3 | WireType.VARINT);
      ...
      private var can_help_water$field:int;
      
      private var max_tree_exp$field:int;
      
      private var left_help_num$field:int;
      
      public function ProtoFriendWishTreeInfo()
      {
         super();
      }
      ...
      public function clearCanHelpWater() : void
      {
         this.hasField$0 = this.hasField$0 & 4.294967279E9;
         this.can_help_water$field = new int();
      }
      
      public function get hasCanHelpWater() : Boolean
      {
         return (this.hasField$0 & 16) != 0;
      }
      
      public function set canHelpWater(param1:int) : void
      {
         this.hasField$0 = this.hasField$0 | 16;
         this.can_help_water$field = param1;
      }
      
      public function get canHelpWater() : int
      {
         return this.can_help_water$field;
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasCanHelpWater)
         {
            WriteUtils.writeTag(param1,WireType.VARINT,5);
            WriteUtils.write$TYPE_INT32(param1,this.can_help_water$field);
         }
