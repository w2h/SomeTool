package serverProto.family
{
   ...
   public final class ProtoQueryFamilyInfoReq extends Message
   {
      
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.family.ProtoQueryFamilyInfoReq.player_id","playerId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var player_id$field:ProtoPlayerKey;
      
      public function ProtoQueryFamilyInfoReq()
      {
         super();
      }
