package serverProto.family
{
   ...
   public final class ProtoQueryFriendWishTreeReq extends Message
   {
      
      public static const FRIEND_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.family.ProtoQueryFriendWishTreeReq.friend_id","friendId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var friend_id$field:ProtoPlayerKey;
      
      public function ProtoQueryFriendWishTreeReq()
      {
         super();
      }
