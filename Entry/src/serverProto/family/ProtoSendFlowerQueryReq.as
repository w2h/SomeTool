package serverProto.family
{
   ...
   public final class ProtoSendFlowerQueryReq extends Message
   {
      
      public static const FRIEND_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.family.ProtoSendFlowerQueryReq.friend_id","friendId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const FRIEND_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.family.ProtoSendFlowerQueryReq.friend_name","friendName",2 << 3 | WireType.LENGTH_DELIMITED);
       
      private var friend_id$field:ProtoPlayerKey;
      
      private var friend_name$field:String;
      
      public function ProtoSendFlowerQueryReq()
      {
         super();
      }
