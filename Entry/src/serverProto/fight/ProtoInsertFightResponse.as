package serverProto.fight
{
   ...
   public final class ProtoInsertFightResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.fight.ProtoInsertFightResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const FIGHT_RES_TO_LOAD:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.fight.ProtoInsertFightResponse.fight_res_to_load","fightResToLoad",2 << 3 | WireType.LENGTH_DELIMITED,ProtoFightResToLoad);
       
      public var ret:ProtoRetInfo;
      
      private var fight_res_to_load$field:serverProto.fight.ProtoFightResToLoad;
      
      public function ProtoInsertFightResponse()
      {
         super();
      }
