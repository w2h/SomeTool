package serverProto.friend
{
   ...
   public final class ProtoChangeDisturbFlagRequest extends Message
   {
      
      public static const DISTURB_FLAG:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.friend.ProtoChangeDisturbFlagRequest.disturb_flag","disturbFlag",1 << 3 | WireType.VARINT);
       
      private var disturb_flag$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoChangeDisturbFlagRequest()
      {
         super();
      }
