package serverProto.guild
{
   ...
   public final class ProtoGuildChiefChuanReq extends Message
   {
      
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.guild.ProtoGuildChiefChuanReq.player_id","playerId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var player_id$field:ProtoPlayerKey;
      
      public function ProtoGuildChiefChuanReq()
      {
         super();
      }
