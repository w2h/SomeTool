package serverProto.guild
{
   ...
   public final class ProtoGuildDungeonAward extends Message
   {
      
      public static const MONEY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildDungeonAward.money","money",1 << 3 | WireType.VARINT);
      
      public static const GUILD_CONTRI:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildDungeonAward.guild_contri","guildContri",2 << 3 | WireType.VARINT);
      
      public static const GUILD_MONEY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildDungeonAward.guild_money","guildMoney",3 << 3 | WireType.VARINT);
      ...
      public function ProtoGuildDungeonAward()
      {
         super();
      }
