package serverProto.guild
{
   ...
   public final class ProtoGuildJoinReq extends Message
   {
      
      public static const GUILD_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("serverProto.guild.ProtoGuildJoinReq.guild_id","guildId",1 << 3 | WireType.VARINT);
       
      private var guild_id$field:UInt64;
      
      public function ProtoGuildJoinReq()
      {
         super();
      }
