package serverProto.guild
{
   ...
   public final class ProtoGuildMemberRemoveReq extends Message
   {
      
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.guild.ProtoGuildMemberRemoveReq.player_id","playerId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var player_id$field:ProtoPlayerKey;
      
      public function ProtoGuildMemberRemoveReq()
      {
         super();
      }
