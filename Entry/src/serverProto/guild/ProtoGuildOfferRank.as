package serverProto.guild
{
   ...
   public final class ProtoGuildOfferRank extends Message
   {
      
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.guild.ProtoGuildOfferRank.player_id","playerId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const PLAYER_NICK:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.guild.ProtoGuildOfferRank.player_nick","playerNick",2 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const CHAKRA:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildOfferRank.chakra","chakra",3 << 3 | WireType.VARINT);
      
      public static const IDNETITY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildOfferRank.idnetity","idnetity",4 << 3 | WireType.VARINT);
      
      public static const VIP_LEVEL:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.guild.ProtoGuildOfferRank.vip_level","vipLevel",5 << 3 | WireType.VARINT,ProtoPlayerVipLevel);
      
      public static const DIAMOND_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.guild.ProtoGuildOfferRank.diamond_info","diamondInfo",6 << 3 | WireType.LENGTH_DELIMITED,ProtoDiamondInfo);
      ...
      public function ProtoGuildOfferRank()
      {
         super();
      }
