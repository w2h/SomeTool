package serverProto.guild
{
   ...
   public final class ProtoGuildUpgradeReq extends Message
   {
      
      public static const UPGRADE_TYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.guild.ProtoGuildUpgradeReq.upgrade_type","upgradeType",1 << 3 | WireType.VARINT);
       
      private var upgrade_type$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoGuildUpgradeReq()
      {
         super();
      }
