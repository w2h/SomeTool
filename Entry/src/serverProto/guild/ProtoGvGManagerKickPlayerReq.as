package serverProto.guild
{
   ...
   public final class ProtoGvGManagerKickPlayerReq extends Message
   {
      
      public static const PLAYER_POS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.guild.ProtoGvGManagerKickPlayerReq.player_pos","playerPos",1 << 3 | WireType.LENGTH_DELIMITED,ProtoGvGBattleFieldPlayerPos);
       
      private var player_pos$field:serverProto.guild.ProtoGvGBattleFieldPlayerPos;
      
      public function ProtoGvGManagerKickPlayerReq()
      {
         super();
      }
