package serverProto.huntlife
{
   ...
   public final class ProtoExchangeRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.huntlife.ProtoExchangeRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const HUNT_LIFE_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.huntlife.ProtoExchangeRsp.hunt_life_info","huntLifeInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoHuntLifeInfo);
       
      public var ret:ProtoRetInfo;
      
      private var hunt_life_info$field:serverProto.huntlife.ProtoHuntLifeInfo;
      
      public function ProtoExchangeRsp()
      {
         super();
      }
