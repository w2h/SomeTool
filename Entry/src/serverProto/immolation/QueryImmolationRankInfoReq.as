package serverProto.immolation
{
   ...
   public final class QueryImmolationRankInfoReq extends Message
   {
      ...
      public static const TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.immolation.QueryImmolationRankInfoReq.type","type",1 << 3 | WireType.VARINT,ImmolationRankType);
