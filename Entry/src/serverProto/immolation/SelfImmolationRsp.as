package serverProto.immolation
{
   ...
   public final class SelfImmolationRsp extends Message
   {
      ...
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.immolation.SelfImmolationRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const IMMOLATION_COUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.immolation.SelfImmolationRsp.immolation_count","immolationCount",2 << 3 | WireType.VARINT);
      
      public static const REST:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.immolation.SelfImmolationRsp.rest","rest",3 << 3 | WireType.VARINT);
      
      public static const ITEM_INFO:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.immolation.SelfImmolationRsp.item_info","itemInfo",4 << 3 | WireType.LENGTH_DELIMITED,ChaKeLaItemInfo);
