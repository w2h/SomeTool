package serverProto.innerPartner
{
   ...
   public final class ProtoQQPetTaskDoneNotify extends Message
   {
      
      public static const TASK_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.innerPartner.ProtoQQPetTaskDoneNotify.task_id","taskId",1 << 3 | WireType.VARINT);
       
      private var task_id$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoQQPetTaskDoneNotify()
      {
         super();
      }
