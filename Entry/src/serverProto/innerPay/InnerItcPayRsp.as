package serverProto.innerPay
{
   ...
   public final class InnerItcPayRsp extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.innerPay.InnerItcPayRsp.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const UIN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.innerPay.InnerItcPayRsp.uin","uin",2 << 3 | WireType.VARINT);
      
      public static const AMOUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.innerPay.InnerItcPayRsp.amount","amount",3 << 3 | WireType.VARINT);
      
      public static const BILLNO:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.innerPay.InnerItcPayRsp.billno","billno",4 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const ALLIN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.innerPay.InnerItcPayRsp.allin","allin",5 << 3 | WireType.VARINT);
      ...
      public function InnerItcPayRsp()
      {
         super();
      }
      ...
      {
         this.billno$field = null;
      }
      
      public function get hasBillno() : Boolean
      {
         return this.billno$field != null;
      }
      
      public function set billno(param1:String) : void
      {
         this.billno$field = param1;
      }
      
      public function get billno() : String
      {
         return this.billno$field;
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasBillno)
         {
            ...
            WriteUtils.write$TYPE_STRING(param1,this.billno$field);
         }
         if(this.hasAllin)
         {
