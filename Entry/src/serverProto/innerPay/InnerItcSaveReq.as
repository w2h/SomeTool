package serverProto.innerPay
{
   ...
   public final class InnerItcSaveReq extends Message
   {
      
      public static const IP_FORWARD:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.innerPay.InnerItcSaveReq.ip_forward","ipForward",1 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const AREA:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.innerPay.InnerItcSaveReq.area","area",2 << 3 | WireType.VARINT);
      
      public static const UIN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.innerPay.InnerItcSaveReq.uin","uin",3 << 3 | WireType.VARINT);
      
      public static const DST_UIN:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.innerPay.InnerItcSaveReq.dst_uin","dstUin",4 << 3 | WireType.VARINT);
      
      public static const AMOUNT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.innerPay.InnerItcSaveReq.amount","amount",5 << 3 | WireType.VARINT);
      
      public static const PORTAL_REQ:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.innerPay.InnerItcSaveReq.portal_req","portalReq",6 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const SOURCE:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.innerPay.InnerItcSaveReq.source","source",7 << 3 | WireType.VARINT);
      
      public static const REMARK:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.innerPay.InnerItcSaveReq.remark","remark",8 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const TRANINFO:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.innerPay.InnerItcSaveReq.traninfo","traninfo",9 << 3 | WireType.LENGTH_DELIMITED);
      ...
      public function InnerItcSaveReq()
      {
         super();
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         WriteUtils.write$TYPE_UINT32(param1,this.dstUin);
         WriteUtils.writeTag(param1,WireType.VARINT,5);
         WriteUtils.write$TYPE_UINT32(param1,this.amount);
         WriteUtils.writeTag(param1,WireType.LENGTH_DELIMITED,6);
         WriteUtils.write$TYPE_STRING(param1,this.portalReq);
         if(this.hasSource)
         {
