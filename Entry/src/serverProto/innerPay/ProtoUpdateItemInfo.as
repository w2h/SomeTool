package serverProto.innerPay
{
   ...
   public final class ProtoUpdateItemInfo extends Message
   {
      ...
      public static const UPDATE_FLAG:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.innerPay.ProtoUpdateItemInfo.update_flag","updateFlag",1 << 3 | WireType.VARINT);
      
      public static const INDEX:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.innerPay.ProtoUpdateItemInfo.index","index",2 << 3 | WireType.VARINT);
      
      public static const ITEM_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.innerPay.ProtoUpdateItemInfo.item_id","itemId",3 << 3 | WireType.VARINT);
      
      public static const NUM:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.innerPay.ProtoUpdateItemInfo.num","num",4 << 3 | WireType.VARINT);
