package serverProto.knowledgeTest
{
   ...
   public final class ProtoKnowledgeTestVoteRequest extends Message
   {
      
      public static const NPC_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.knowledgeTest.ProtoKnowledgeTestVoteRequest.npc_id","npcId",1 << 3 | WireType.VARINT);
       
      private var npc_id$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProtoKnowledgeTestVoteRequest()
      {
         super();
      }
