package serverProto.ninjaLegend
{
   ...
   public final class ProotTakeNinjaLegendPrizeRequest extends Message
   {
      
      public static const NINJA_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.ninjaLegend.ProotTakeNinjaLegendPrizeRequest.ninja_id","ninjaId",1 << 3 | WireType.VARINT);
       
      private var ninja_id$field:uint;
      
      private var hasField$0:uint = 0;
      
      public function ProotTakeNinjaLegendPrizeRequest()
      {
         super();
      }
