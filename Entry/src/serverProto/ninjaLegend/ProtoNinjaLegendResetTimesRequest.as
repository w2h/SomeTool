package serverProto.ninjaLegend
{
   ...
   public final class ProtoNinjaLegendResetTimesRequest extends Message
   {
      
      public static const NINJA_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.ninjaLegend.ProtoNinjaLegendResetTimesRequest.ninja_id","ninjaId",1 << 3 | WireType.VARINT);
      
      public static const ZHANG_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.ninjaLegend.ProtoNinjaLegendResetTimesRequest.zhang_id","zhangId",2 << 3 | WireType.VARINT);
      ...
      public function ProtoNinjaLegendResetTimesRequest()
      {
         super();
      }
