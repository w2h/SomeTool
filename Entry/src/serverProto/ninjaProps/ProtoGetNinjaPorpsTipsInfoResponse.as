package serverProto.ninjaProps
{
   ...
   public final class ProtoGetNinjaPorpsTipsInfoResponse extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.ninjaProps.ProtoGetNinjaPorpsTipsInfoResponse.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const NINJA_PROPS_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.ninjaProps.ProtoGetNinjaPorpsTipsInfoResponse.ninja_props_info","ninjaPropsInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoNinjaPropsInfo);
       
      public var retInfo:ProtoRetInfo;
      
      private var ninja_props_info$field:serverProto.ninjaProps.ProtoNinjaPropsInfo;
      
      public function ProtoGetNinjaPorpsTipsInfoResponse()
      {
         super();
      }
