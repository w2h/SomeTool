package serverProto.ninjaProps
{
   ...
   public final class ProtoNinjaPropsLevelUpResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.ninjaProps.ProtoNinjaPropsLevelUpResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const NINJA_PROPS_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.ninjaProps.ProtoNinjaPropsLevelUpResponse.ninja_props_info","ninjaPropsInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoNinjaPropsPositionInfo);
       
      public var ret:ProtoRetInfo;
      
      private var ninja_props_info$field:serverProto.ninjaProps.ProtoNinjaPropsPositionInfo;
      
      public function ProtoNinjaPropsLevelUpResponse()
      {
         super();
      }
