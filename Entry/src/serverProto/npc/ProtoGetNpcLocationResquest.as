package serverProto.npc
{
   ...
   public final class ProtoGetNpcLocationResquest extends Message
   {
      
      public static const SCENE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.npc.ProtoGetNpcLocationResquest.scene_id","sceneId",1 << 3 | WireType.VARINT);
       
      private var scene_id$field:int;
      
      private var hasField$0:uint = 0;
      
      public function ProtoGetNpcLocationResquest()
      {
         super();
      }
