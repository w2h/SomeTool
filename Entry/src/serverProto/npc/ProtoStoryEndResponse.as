package serverProto.npc
{
   ...
   public final class ProtoStoryEndResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.npc.ProtoStoryEndResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const SCENE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.npc.ProtoStoryEndResponse.scene","scene",2 << 3 | WireType.VARINT);
      
      public static const LOCATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.npc.ProtoStoryEndResponse.location","location",3 << 3 | WireType.LENGTH_DELIMITED,ProtoPoint);
      ...
      public function ProtoStoryEndResponse()
      {
         super();
      }
