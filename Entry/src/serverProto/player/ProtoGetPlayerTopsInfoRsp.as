package serverProto.player
{
   ...
   public final class ProtoGetPlayerTopsInfoRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.player.ProtoGetPlayerTopsInfoRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const PLAYER_TIPS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.player.ProtoGetPlayerTopsInfoRsp.player_tips","playerTips",2 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerTipsInfo);
       
      private var ret$field:ProtoRetInfo;
      
      private var player_tips$field:serverProto.player.ProtoPlayerTipsInfo;
      
      public function ProtoGetPlayerTopsInfoRsp()
      {
         super();
      }
