package serverProto.player
{
   ...
   public final class ProtoUseSceneTeleportResponse extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.player.ProtoUseSceneTeleportResponse.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const LOCATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.player.ProtoUseSceneTeleportResponse.location","location",2 << 3 | WireType.LENGTH_DELIMITED,ProtoLocationInfo);
      
      public static const TIMES_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.player.ProtoUseSceneTeleportResponse.times_info","timesInfo",3 << 3 | WireType.LENGTH_DELIMITED,ProtoSceneTeleportTimesInfo);
      ...
      public function ProtoUseSceneTeleportResponse()
      {
         super();
      }
