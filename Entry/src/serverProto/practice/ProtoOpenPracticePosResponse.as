package serverProto.practice
{
   ...
   public final class ProtoOpenPracticePosResponse extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.practice.ProtoOpenPracticePosResponse.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const PRACTICE_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.practice.ProtoOpenPracticePosResponse.practice_info","practiceInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoPracticeInfo);
       
      public var retInfo:ProtoRetInfo;
      
      private var practice_info$field:serverProto.practice.ProtoPracticeInfo;
      
      public function ProtoOpenPracticePosResponse()
      {
         super();
      }
