package serverProto.randStore
{
   ...
   public final class ProtoGetRandStoreInfoRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.randStore.ProtoGetRandStoreInfoRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const STORE_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.randStore.ProtoGetRandStoreInfoRsp.store_info","storeInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoRandStoreInfo);
       
      public var ret:ProtoRetInfo;
      
      private var store_info$field:serverProto.randStore.ProtoRandStoreInfo;
      
      public function ProtoGetRandStoreInfoRsp()
      {
         super();
      }
