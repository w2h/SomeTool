package serverProto.rank
{
   ...
   public final class ProtoNinjaLegendTreasureRank extends Message
   {
      
      public static const RANK:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaLegendTreasureRank.rank","rank",1 << 3 | WireType.VARINT);
      
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoNinjaLegendTreasureRank.player_id","playerId",2 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const PLAYER_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rank.ProtoNinjaLegendTreasureRank.player_name","playerName",3 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const ROLE_CATEGORY:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaLegendTreasureRank.role_category","roleCategory",4 << 3 | WireType.VARINT);
      
      public static const ROLE_LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaLegendTreasureRank.role_level","roleLevel",5 << 3 | WireType.VARINT);
      
      public static const COMBAT_POWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaLegendTreasureRank.combat_power","combatPower",6 << 3 | WireType.VARINT);
      
      public static const TREASURE_NUM:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaLegendTreasureRank.treasure_num","treasureNum",7 << 3 | WireType.VARINT);
      
      public static const TITLE_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoNinjaLegendTreasureRank.title_id","titleId",9 << 3 | WireType.VARINT);
      
      public static const DIAMOND_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoNinjaLegendTreasureRank.diamond_info","diamondInfo",10 << 3 | WireType.LENGTH_DELIMITED,ProtoDiamondInfo);
      ...
      private var treasure_num$field:uint;
      
      private var title_id$field:uint;
      
      private var diamond_info$field:ProtoDiamondInfo;
      
      public function ProtoNinjaLegendTreasureRank()
      {
         super();
      }
      ...
      public function clearTreasureNum() : void
      {
         this.hasField$0 = this.hasField$0 & 4.294967279E9;
         this.treasure_num$field = new uint();
      }
      
      public function get hasTreasureNum() : Boolean
      {
         return (this.hasField$0 & 16) != 0;
      }
      
      public function set treasureNum(param1:uint) : void
      {
         this.hasField$0 = this.hasField$0 | 16;
         this.treasure_num$field = param1;
      }
      
      public function get treasureNum() : uint
      {
         return this.treasure_num$field;
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasTreasureNum)
         {
            WriteUtils.writeTag(param1,WireType.VARINT,7);
            WriteUtils.write$TYPE_UINT32(param1,this.treasure_num$field);
         }
         if(this.hasTitleId)
         {
