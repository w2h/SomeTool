package serverProto.rank
{
   ...
   public final class ProtoNinjaNumRankReq extends Message
   {
      
      public static const MERGED_RANK:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("serverProto.rank.ProtoNinjaNumRankReq.merged_rank","mergedRank",1 << 3 | WireType.VARINT);
       
      private var merged_rank$field:Boolean;
      
      private var hasField$0:uint = 0;
      
      public function ProtoNinjaNumRankReq()
      {
         super();
      }
