package serverProto.rank
{
   ...
   public final class ProtoRankItemInfo extends Message
   {
      
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoRankItemInfo.player_id","playerId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rank.ProtoRankItemInfo.rank","rank",2 << 3 | WireType.VARINT);
      
      public static const ROLE_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rank.ProtoRankItemInfo.role_name","roleName",3 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const ROLE_CATEGORY:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.rank.ProtoRankItemInfo.role_category","roleCategory",4 << 3 | WireType.VARINT,ProtoRoleCategoryType);
      
      public static const LEVEL:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoRankItemInfo.level","level",5 << 3 | WireType.VARINT);
      
      public static const COMBAT_POWER:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoRankItemInfo.combat_power","combatPower",6 << 3 | WireType.VARINT);
      
      public static const ROLE_EXP:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoRankItemInfo.role_exp","roleExp",7 << 3 | WireType.VARINT);
      
      public static const VIP_LEVEL:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.rank.ProtoRankItemInfo.vip_level","vipLevel",8 << 3 | WireType.VARINT,ProtoPlayerVipLevel);
      
      public static const TITLE_ID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoRankItemInfo.title_id","titleId",9 << 3 | WireType.VARINT);
      
      public static const DIAMOND_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rank.ProtoRankItemInfo.diamond_info","diamondInfo",10 << 3 | WireType.LENGTH_DELIMITED,ProtoDiamondInfo);
      ...
      public function ProtoRankItemInfo()
      {
         super();
      }
      ...
      public function set roleExp(param1:uint) : void
      {
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasRoleCategory)
         {
            ...
            WriteUtils.write$TYPE_ENUM(param1,this.role_category$field);
         }
         if(this.hasLevel)
         {
         ...
         if(this.hasRoleExp)
         {
            ...
            WriteUtils.write$TYPE_UINT32(param1,this.role_exp$field);
         }
         if(this.hasVipLevel)
         {
