package serverProto.rank
{
   ...
   public final class ProtoTitleToolsReq extends Message
   {
      
      public static const TYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.rank.ProtoTitleToolsReq.type","type",1 << 3 | WireType.VARINT);
      
      public static const DATA1:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rank.ProtoTitleToolsReq.data1","data1",2 << 3 | WireType.VARINT);
      
      public static const DATA2:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rank.ProtoTitleToolsReq.data2","data2",3 << 3 | WireType.VARINT);
      
      public static const DATA3:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rank.ProtoTitleToolsReq.data3","data3",4 << 3 | WireType.VARINT);
      ...
      public function ProtoTitleToolsReq()
      {
         super();
      }
