package serverProto.rankBattle
{
   ...
   public final class ProtoBattleRivalInfo extends Message
   {
      ...
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rankBattle.ProtoBattleRivalInfo.player_id","playerId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const ROLE_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rankBattle.ProtoBattleRivalInfo.role_name","roleName",2 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const CAREER:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoBattleRivalInfo.career","career",3 << 3 | WireType.VARINT);
      
      public static const RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoBattleRivalInfo.rank","rank",4 << 3 | WireType.VARINT);
      
      public static const COMBAT_POWER:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoBattleRivalInfo.combat_power","combatPower",5 << 3 | WireType.VARINT);
      
      public static const LEVEL:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoBattleRivalInfo.level","level",6 << 3 | WireType.VARINT);
      
      public static const NINJA_LIST:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rankBattle.ProtoBattleRivalInfo.ninja_list","ninjaList",7 << 3 | WireType.LENGTH_DELIMITED,ProtoBattleRivalNinjaInfo);
      
      public static const GUILD_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rankBattle.ProtoBattleRivalInfo.guild_name","guildName",8 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const VIP_LEVEL:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.rankBattle.ProtoBattleRivalInfo.vip_level","vipLevel",9 << 3 | WireType.VARINT,ProtoPlayerVipLevel);
      
      public static const DIAMOND_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rankBattle.ProtoBattleRivalInfo.diamond_info","diamondInfo",10 << 3 | WireType.LENGTH_DELIMITED,ProtoDiamondInfo);
      
      public static const SUMMON_MONSTER_ID:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.rankBattle.ProtoBattleRivalInfo.summon_monster_id","summonMonsterId",11 << 3 | WireType.VARINT);
      
      public static const GUILD_ID:FieldDescriptor$TYPE_UINT64 = new FieldDescriptor$TYPE_UINT64("serverProto.rankBattle.ProtoBattleRivalInfo.guild_id","guildId",12 << 3 | WireType.VARINT);
      ...
      public function set ninjaList(param1:serverProto.rankBattle.ProtoBattleRivalNinjaInfo) : void
      {
