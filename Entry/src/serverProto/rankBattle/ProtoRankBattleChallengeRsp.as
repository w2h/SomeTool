package serverProto.rankBattle
{
   ...
   public final class ProtoRankBattleChallengeRsp extends Message
   {
      ...
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rankBattle.ProtoRankBattleChallengeRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const CHALLENGE_RESULT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattleChallengeRsp.challenge_result","challengeResult",2 << 3 | WireType.VARINT);
      
      public static const MONEY_AWARD:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattleChallengeRsp.money_award","moneyAward",6 << 3 | WireType.VARINT);
