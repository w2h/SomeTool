package serverProto.rankBattle
{
   ...
   public final class ProtoRankBattlePlayerInfo extends Message
   {
      ...
      public static const LEFT_TIMES:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.left_times","leftTimes",1 << 3 | WireType.VARINT);
      
      public static const LEFT_PAY_TIMES:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.left_pay_times","leftPayTimes",2 << 3 | WireType.VARINT);
      
      public static const CD_TIME:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.cd_time","cdTime",3 << 3 | WireType.VARINT);
      
      public static const MY_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.my_rank","myRank",4 << 3 | WireType.VARINT);
      
      public static const COMBAT_POWER:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.combat_power","combatPower",5 << 3 | WireType.VARINT);
      
      public static const CONTINUOUS_WIN:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.continuous_win","continuousWin",6 << 3 | WireType.VARINT);
      
      public static const RANK_AWARD_MONEY:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.rank_award_money","rankAwardMoney",7 << 3 | WireType.VARINT);
      
      public static const RANK_AWARD_BATTLE_MONEY:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.rank_award_battle_money","rankAwardBattleMoney",8 << 3 | WireType.VARINT);
      
      public static const BUY_TIMES:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.buy_times","buyTimes",9 << 3 | WireType.VARINT);
      
      public static const BUY_TIMES_MONEY_INGOT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.buy_times_money_ingot","buyTimesMoneyIngot",10 << 3 | WireType.VARINT);
      
      public static const CD_TIME_MONEY_INGOT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.cd_time_money_ingot","cdTimeMoneyIngot",11 << 3 | WireType.VARINT);
      
      public static const NINJA_TIPS:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rankBattle.ProtoRankBattlePlayerInfo.ninja_tips","ninjaTips",12 << 3 | WireType.LENGTH_DELIMITED,ProtoBattleRivalNinjaInfo);
      
      public static const GLOBAL_MY_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattlePlayerInfo.global_my_rank","globalMyRank",13 << 3 | WireType.VARINT);
      ...
      public function set ninjaTips(param1:serverProto.rankBattle.ProtoBattleRivalNinjaInfo) : void
      {
      ...
      public function clearGlobalMyRank() : void
      {
         ...
         this.global_my_rank$field = new int();
      }
      ...
      public function set globalMyRank(param1:int) : void
      {
         this.hasField$0 = this.hasField$0 | 2048;
         this.global_my_rank$field = param1;
      }
      
      public function get globalMyRank() : int
      {
         return this.global_my_rank$field;
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         if(this.hasMyRank)
         {
            ...
            WriteUtils.write$TYPE_INT32(param1,this.my_rank$field);
         }
         ...
         if(this.hasGlobalMyRank)
         {
            WriteUtils.writeTag(param1,WireType.VARINT,13);
            WriteUtils.write$TYPE_INT32(param1,this.global_my_rank$field);
         }
         for(_loc2_ in this)
         {
