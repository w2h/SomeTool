package serverProto.rankBattle
{
   ...
   public final class ProtoRankBattleReportInfo extends Message
   {
      ...
      public static const TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.rankBattle.ProtoRankBattleReportInfo.type","type",1 << 3 | WireType.VARINT,ProtoReportType);
      
      public static const RIVAL_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rankBattle.ProtoRankBattleReportInfo.rival_id","rivalId",2 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const RIVAL_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.rankBattle.ProtoRankBattleReportInfo.rival_name","rivalName",3 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const NEW_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattleReportInfo.new_rank","newRank",4 << 3 | WireType.VARINT);
      
      public static const OLD_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.rankBattle.ProtoRankBattleReportInfo.old_rank","oldRank",5 << 3 | WireType.VARINT);
