package serverProto.redPackage
{
   ...
   public final class ProtoToolsRedPackageReq extends Message
   {
      
      public static const TYPE:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.redPackage.ProtoToolsRedPackageReq.type","type",1 << 3 | WireType.VARINT);
      
      public static const DATA1:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.redPackage.ProtoToolsRedPackageReq.data1","data1",2 << 3 | WireType.VARINT);
      
      public static const DATA2:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.redPackage.ProtoToolsRedPackageReq.data2","data2",3 << 3 | WireType.VARINT);
      
      public static const DATA3:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("serverProto.redPackage.ProtoToolsRedPackageReq.data3","data3",4 << 3 | WireType.VARINT);
      ...
      public function ProtoToolsRedPackageReq()
      {
         super();
      }
