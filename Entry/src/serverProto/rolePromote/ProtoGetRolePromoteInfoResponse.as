package serverProto.rolePromote
{
   ...
   public final class ProtoGetRolePromoteInfoResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rolePromote.ProtoGetRolePromoteInfoResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const REMAIN_STAR:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.rolePromote.ProtoGetRolePromoteInfoResponse.remain_star","remainStar",2 << 3 | WireType.VARINT);
      
      public static const PREV_START:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.rolePromote.ProtoGetRolePromoteInfoResponse.prev_start","prevStart",3 << 3 | WireType.VARINT);
      
      public static const ATTR_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.rolePromote.ProtoGetRolePromoteInfoResponse.attr_info","attrInfo",4 << 3 | WireType.LENGTH_DELIMITED,ProtoPromoteAttrInfo);
      ...
      public function ProtoGetRolePromoteInfoResponse()
      {
         super();
      }
