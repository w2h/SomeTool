package serverProto.sceneEscort
{
   ...
   public final class ProtoSceneEscortApplyInfo extends Message
   {
      
      public static const BASE_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.sceneEscort.ProtoSceneEscortApplyInfo.base_info","baseInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerBaseInfo);
      
      public static const TASK_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.sceneEscort.ProtoSceneEscortApplyInfo.task_id","taskId",2 << 3 | WireType.VARINT);
      ...
      public function ProtoSceneEscortApplyInfo()
      {
         super();
      }
