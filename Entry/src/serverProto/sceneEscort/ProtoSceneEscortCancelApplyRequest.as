package serverProto.sceneEscort
{
   ...
   public final class ProtoSceneEscortCancelApplyRequest extends Message
   {
      
      public static const PLAYER_KEY:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.sceneEscort.ProtoSceneEscortCancelApplyRequest.player_key","playerKey",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var player_key$field:ProtoPlayerKey;
      
      public function ProtoSceneEscortCancelApplyRequest()
      {
         super();
      }
