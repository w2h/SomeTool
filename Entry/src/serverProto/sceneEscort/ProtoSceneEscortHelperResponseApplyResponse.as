package serverProto.sceneEscort
{
   ...
   public final class ProtoSceneEscortHelperResponseApplyResponse extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.sceneEscort.ProtoSceneEscortHelperResponseApplyResponse.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const APPLY_LIST:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.sceneEscort.ProtoSceneEscortHelperResponseApplyResponse.apply_list","applyList",2 << 3 | WireType.LENGTH_DELIMITED,ProtoSceneEscortApplyInfo);
      
      public static const CAN_HELP_COUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.sceneEscort.ProtoSceneEscortHelperResponseApplyResponse.can_help_count","canHelpCount",3 << 3 | WireType.VARINT);
      
      public static const REMAINDER_HELP_COUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.sceneEscort.ProtoSceneEscortHelperResponseApplyResponse.remainder_help_count","remainderHelpCount",4 << 3 | WireType.VARINT);
      ...
      public function ProtoSceneEscortHelperResponseApplyResponse()
      {
         this.applyList = [];
         super();
      }
