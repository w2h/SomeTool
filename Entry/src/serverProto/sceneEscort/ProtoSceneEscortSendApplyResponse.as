package serverProto.sceneEscort
{
   ...
   public final class ProtoSceneEscortSendApplyResponse extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.sceneEscort.ProtoSceneEscortSendApplyResponse.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
       
      private var ret_info$field:ProtoRetInfo;
      
      public function ProtoSceneEscortSendApplyResponse()
      {
         super();
      }
