package serverProto.serverPtlogin
{
   ...
   public final class PtloginRequest extends Message
   {
      
      public static const SKEY:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.serverPtlogin.PtloginRequest.skey","skey",1 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const SEPERATE_SKEY:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.serverPtlogin.PtloginRequest.seperate_skey","seperateSkey",2 << 3 | WireType.LENGTH_DELIMITED);
       
      private var skey$field:String;
      
      private var seperate_skey$field:String;
      
      public function PtloginRequest()
      {
         super();
      }
