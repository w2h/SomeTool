package serverProto.skill
{
   ...
   public final class ProtoGetSkillInfoRequest extends Message
   {
      
      public static const KEY:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.skill.ProtoGetSkillInfoRequest.key","key",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var key$field:ProtoPlayerKey;
      
      public function ProtoGetSkillInfoRequest()
      {
         super();
      }
