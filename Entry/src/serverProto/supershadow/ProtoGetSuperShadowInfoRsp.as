package serverProto.supershadow
{
   ...
   public final class ProtoGetSuperShadowInfoRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.supershadow.ProtoGetSuperShadowInfoRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const SUPER_SHADOW_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.supershadow.ProtoGetSuperShadowInfoRsp.super_shadow_info","superShadowInfo",2 << 3 | WireType.LENGTH_DELIMITED,ProtoSuperShadowInfo);
       
      public var ret:ProtoRetInfo;
      
      private var super_shadow_info$field:serverProto.supershadow.ProtoSuperShadowInfo;
      
      public function ProtoGetSuperShadowInfoRsp()
      {
         super();
      }
