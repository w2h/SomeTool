package serverProto.tabard
{
   ...
   public final class ProtoTabardSetShowFlagReq extends Message
   {
      
      public static const SHOW_FLAG:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.tabard.ProtoTabardSetShowFlagReq.show_flag","showFlag",1 << 3 | WireType.VARINT);
       
      private var show_flag$field:int;
      
      private var hasField$0:uint = 0;
      
      public function ProtoTabardSetShowFlagReq()
      {
         super();
      }
