package serverProto.tactic
{
   ...
   public final class ProtoGetTacticInfoReq extends Message
   {
      
      public static const NINJA_SOURCE_TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.tactic.ProtoGetTacticInfoReq.ninja_source_type","ninjaSourceType",1 << 3 | WireType.VARINT,NinjaSourceType);
       
      private var ninja_source_type$field:int;
      
      private var hasField$0:uint = 0;
      
      public function ProtoGetTacticInfoReq()
      {
         super();
      }
