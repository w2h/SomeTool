package serverProto.task
{
   ...
   public final class ProtoTaskInfoListResp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.task.ProtoTaskInfoListResp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const TASKS:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.task.ProtoTaskInfoListResp.tasks","tasks",2 << 3 | WireType.LENGTH_DELIMITED,ProtoTaskInfo);
      
      public static const TASK_COUNT_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.task.ProtoTaskInfoListResp.task_count_info","taskCountInfo",3 << 3 | WireType.LENGTH_DELIMITED,ProtoTaskCountInfo);
      ...
      public function ProtoTaskInfoListResp()
      {
         this.tasks = [];
         super();
      }
