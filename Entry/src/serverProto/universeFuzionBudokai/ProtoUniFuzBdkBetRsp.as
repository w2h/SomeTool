package serverProto.universeFuzionBudokai
{
   ...
   public final class ProtoUniFuzBdkBetRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.universeFuzionBudokai.ProtoUniFuzBdkBetRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const HAVE_SCORE:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkBetRsp.have_score","haveScore",2 << 3 | WireType.VARINT);
      
      public static const HAVE_CHIP:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkBetRsp.have_chip","haveChip",3 << 3 | WireType.VARINT);
      
      public static const LEFT_SCORE_BET_TIMES:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkBetRsp.left_score_bet_times","leftScoreBetTimes",4 << 3 | WireType.VARINT);
      
      public static const LEFT_CHIP_BET_TIMES:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkBetRsp.left_chip_bet_times","leftChipBetTimes",5 << 3 | WireType.VARINT);
      
      public static const BET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.universeFuzionBudokai.ProtoUniFuzBdkBetRsp.bet_info","betInfo",6 << 3 | WireType.LENGTH_DELIMITED,ProtoUniFuzBdkBetInfo);
      ...
      public function ProtoUniFuzBdkBetRsp()
      {
         super();
      }
