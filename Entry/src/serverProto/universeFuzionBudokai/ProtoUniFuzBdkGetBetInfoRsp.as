package serverProto.universeFuzionBudokai
{
   ...
   public final class ProtoUniFuzBdkGetBetInfoRsp extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.universeFuzionBudokai.ProtoUniFuzBdkGetBetInfoRsp.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const HAVE_SCORE:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkGetBetInfoRsp.have_score","haveScore",2 << 3 | WireType.VARINT);
      
      public static const HAVE_CHIP:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkGetBetInfoRsp.have_chip","haveChip",3 << 3 | WireType.VARINT);
      
      public static const LEFT_SCORE_BET_TIMES:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkGetBetInfoRsp.left_score_bet_times","leftScoreBetTimes",4 << 3 | WireType.VARINT);
      
      public static const LEFT_CHIP_BET_TIMES:FieldDescriptor$TYPE_SINT32 = new FieldDescriptor$TYPE_SINT32("serverProto.universeFuzionBudokai.ProtoUniFuzBdkGetBetInfoRsp.left_chip_bet_times","leftChipBetTimes",5 << 3 | WireType.VARINT);
      
      public static const BET_INFO:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("serverProto.universeFuzionBudokai.ProtoUniFuzBdkGetBetInfoRsp.bet_info","betInfo",6 << 3 | WireType.LENGTH_DELIMITED,ProtoUniFuzBdkBetInfo);
      ...
      [ArrayElementType("serverProto.universeFuzionBudokai.ProtoUniFuzBdkBetInfo")]
      public var betInfo:Array;
      
      public function ProtoUniFuzBdkGetBetInfoRsp()
      {
         this.betInfo = [];
         super();
      }
      ...
      override final function writeToBuffer(param1:WritingBuffer) : void
      {
         ...
         var _loc2_:uint = 0;
         while(_loc2_ < this.betInfo.length)
         {
            WriteUtils.writeTag(param1,WireType.LENGTH_DELIMITED,6);
            WriteUtils.write$TYPE_MESSAGE(param1,this.betInfo[_loc2_]);
            _loc2_++;
         }
         for(_loc3_ in this)
         {
