package serverProto.universeFuzionPre
{
   ...
   public final class ProtoGetUserSimpleInfoReq extends Message
   {
      
      public static const PLAYER_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.universeFuzionPre.ProtoGetUserSimpleInfoReq.player_id","playerId",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var player_id$field:ProtoPlayerKey;
      
      public function ProtoGetUserSimpleInfoReq()
      {
         super();
      }
