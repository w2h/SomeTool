package serverProto.universeFuzionPre
{
   ...
   public final class ProtoRankBattleChallengeReq extends Message
   {
      ...
      public static const RIVAL_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.universeFuzionPre.ProtoRankBattleChallengeReq.rival_rank","rivalRank",1 << 3 | WireType.VARINT);
