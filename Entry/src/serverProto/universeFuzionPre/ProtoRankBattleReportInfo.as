package serverProto.universeFuzionPre
{
   ...
   public final class ProtoRankBattleReportInfo extends Message
   {
      
      public static const TYPE:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("serverProto.universeFuzionPre.ProtoRankBattleReportInfo.type","type",1 << 3 | WireType.VARINT,ProtoReportType);
      
      public static const RIVAL_ID:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.universeFuzionPre.ProtoRankBattleReportInfo.rival_id","rivalId",2 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
      
      public static const RIVAL_NAME:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("serverProto.universeFuzionPre.ProtoRankBattleReportInfo.rival_name","rivalName",3 << 3 | WireType.LENGTH_DELIMITED);
      
      public static const NEW_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.universeFuzionPre.ProtoRankBattleReportInfo.new_rank","newRank",4 << 3 | WireType.VARINT);
      
      public static const OLD_RANK:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.universeFuzionPre.ProtoRankBattleReportInfo.old_rank","oldRank",5 << 3 | WireType.VARINT);
      ...
      public function ProtoRankBattleReportInfo()
      {
         super();
      }
