package serverProto.user
{
   ...
   public final class ProtoGetPlayerInfoRequest extends Message
   {
      
      public static const PLAYER_KEY:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.user.ProtoGetPlayerInfoRequest.player_key","playerKey",1 << 3 | WireType.LENGTH_DELIMITED,ProtoPlayerKey);
       
      private var player_key$field:ProtoPlayerKey;
      
      public function ProtoGetPlayerInfoRequest()
      {
         super();
      }
