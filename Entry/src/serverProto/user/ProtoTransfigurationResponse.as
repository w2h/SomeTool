package serverProto.user
{
   ...
   public final class ProtoTransfigurationResponse extends Message
   {
      
      public static const RET_INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.user.ProtoTransfigurationResponse.ret_info","retInfo",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const INFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.user.ProtoTransfigurationResponse.info","info",2 << 3 | WireType.LENGTH_DELIMITED,ProtoTransfigurationInfo);
       
      private var ret_info$field:ProtoRetInfo;
      
      private var info$field:serverProto.user.ProtoTransfigurationInfo;
      
      public function ProtoTransfigurationResponse()
      {
         super();
      }
