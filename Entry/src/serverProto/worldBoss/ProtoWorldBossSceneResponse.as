package serverProto.worldBoss
{
   ...
   public final class ProtoWorldBossSceneResponse extends Message
   {
      
      public static const RET:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.worldBoss.ProtoWorldBossSceneResponse.ret","ret",1 << 3 | WireType.LENGTH_DELIMITED,ProtoRetInfo);
      
      public static const SCENE_ID:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("serverProto.worldBoss.ProtoWorldBossSceneResponse.scene_id","sceneId",2 << 3 | WireType.VARINT);
      
      public static const LOCATION:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("serverProto.worldBoss.ProtoWorldBossSceneResponse.location","location",3 << 3 | WireType.LENGTH_DELIMITED,ProtoPoint);
      ...
      public function ProtoWorldBossSceneResponse()
      {
         super();
      }
