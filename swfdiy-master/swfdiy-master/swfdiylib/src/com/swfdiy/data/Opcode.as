package com.swfdiy.data
{
	public class Opcode
	{
		...
		private static var _paramInfo:Object;
		public static function getParamInfo():Object {
			if (_paramInfo == null) {
				_paramInfo = {};
				_paramInfo[OP_debugfile] = [{'type':"u32", 'target':"string"}];
				_paramInfo[OP_pushstring] = [{'type':"u32", 'target':"string"}];
				
				
				_paramInfo[OP_pushnamespace] = [{'type':"u32", 'target':"namespace"}];
				_paramInfo[OP_pushint] = [{'type':"u32", 'target':"int"}];
				_paramInfo[OP_pushuint] = [{'type':"u32", 'target':"uint"}];
				_paramInfo[OP_pushdouble] = [{'type':"u32", 'target':"double"}];
				
				_paramInfo[OP_getsuper] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_setsuper] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_getproperty] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_initproperty] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_setproperty] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_getlex] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_findpropstrict] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_findproperty] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_finddef] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_deleteproperty] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_istype] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_coerce] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_astype] = [{'type':"u32", 'target':"multiname"}];
				_paramInfo[OP_getdescendants] = [{'type':"u32", 'target':"multiname"}];
				
				_paramInfo[OP_constructprop] = [{'type':"u32", 'target':"multiname"},{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_callproperty] = [{'type':"u32", 'target':"multiname"},{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_callproplex] = [{'type':"u32", 'target':"multiname"},{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_callsuper] = [{'type':"u32", 'target':"multiname"},{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_callsupervoid] = [{'type':"u32", 'target':"multiname"},{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_callpropvoid] = [{'type':"u32", 'target':"multiname"},{'type':"u32", 'target':"intvalue"}];
				
				
				_paramInfo[OP_newfunction] = [{'type':"u32", 'target':"method"}];
				_paramInfo[OP_callstatic] = [{'type':"u32", 'target':"method"},{'type':"u32", 'target':"intvalue"}];
				
				
				_paramInfo[OP_newclass] = [{'type':"u32", 'target':"instance"}];
				_paramInfo[OP_inclocal_i] = [{'type':"u32", 'target':"localreg"}];
				_paramInfo[OP_declocal_i] = [{'type':"u32", 'target':"localreg"}];
				_paramInfo[OP_getlocal] = [{'type':"u32", 'target':"localreg"}];
				_paramInfo[OP_kill] = [{'type':"u32", 'target':"localreg"}];
				_paramInfo[OP_setlocal] = [{'type':"u32", 'target':"localreg"}];
				_paramInfo[OP_debugline] = [{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_getglobalslot] = [{'type':"u32", 'target':"globalslot"}];
				_paramInfo[OP_getslot] = [{'type':"u32", 'target':"objectslot"}];
				_paramInfo[OP_setglobalslot] = [{'type':"u32", 'target':"globalslot"}];
				_paramInfo[OP_setslot] = [{'type':"u32", 'target':"objectslot"}];
				_paramInfo[OP_pushshort] = [{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_newcatch] = [{'type':"u32", 'target':"methodexception"}];
				
				_paramInfo[OP_debug] = [{'type':"u8", 'target':"intvalue"},{'type':"u32", 'target':"string"},{'type':"u8", 'target':"localreg"},{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_newobject] = [{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_newarray] = [{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_call] = [{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_construct] = [{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_constructsuper] = [{'type':"u32", 'target':"intvalue"}];
				_paramInfo[OP_pushbyte] = [{'type':"u8", 'target':"intvalue"}];
				_paramInfo[OP_getscopeobject] = [{'type':"u8", 'target':"localstack"}];
				_paramInfo[OP_hasnext2] = [{'type':"u32", 'target':"localreg"},{'type':"u32", 'target':"localreg"}];

			}
			//note:jmp ,switch opcodes has special params
			return _paramInfo;
		}
